...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/Arief-sc/otw/main/ip > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/Arief-sc/otw/main/ip | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/Arief-sc/otw/main/ip | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
Exp=$(curl -sS https://raw.githubusercontent.com/Arief-sc/otw/main/ip | grep $MYIP | awk '{print $3}')
fi
...
domain=$host(cat /var/lib/SIJA/ipvps.conf | cut -d'=' -f2)
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
echo -e "${BICyan} └─────────────────────────────────────────────────────┘${NC}"
echo -e "         ${BICyan}┌─────────────────────────────────────┐${NC}"
echo -e "         ${BICyan}│  Version     ${NC} : Arief-sc / v4 Lts."
...
9) clear ; genssl ;;
10) clear ; jam ;;
6969) clear ; wget https://raw.githubusercontent.com/Arief-sc/sungut/main/update.sh && chmod +x update.sh && ./update.sh && rm -f /root/update.sh ;;
0) clear ; menu ;;
x) exit ;;
